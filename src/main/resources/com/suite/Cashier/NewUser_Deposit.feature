...
#@RegisterNewCard 
#Scenario:
#Register an incomplete  credit card number will displayed error message 
#	Given I navigate to the homepage on "<browser>" 
#	When I have logged in username as "safecharge15" and password "Bola123$%^" 
...
#@RegisterNewCard 
#Scenario:
#Verifying if expiration date will displayed error message when not  date month selected. 
#	Given I navigate to the homepage on "<browser>" 
#	When I have logged in username as "safecharge15" and password "Bola123$%^" 
#	And  I click a Depositbutton 
#	And I click on Other Payment Methods Card Logo
...
#@RegisterNewCard 
#Scenario:
#Checking if CVV error message will be displayed when cvv text box is ommited or incompeleted 
#	Given I navigate to the homepage on "<browser>" 
#	When I have logged in username as "safecharge15" and password "Bola123$%^" 
#	And  I click a Depositbutton 
#	And I click on Other Payment Methods Card Logo
...
#	And  I click a Depositbutton 
#	And I click on Other Payment Methods Card Logo
#	And I enter CardVisa Number as "4265 0318 7445 6897" 
#	And I entry Expiry card month as "03" 
#	And I enter Expiry card year as "2020" 
#	And I enter CVV as "351" 
...
#	When I enter regUsername as "Safecharge016" 
